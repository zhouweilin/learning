(function(factory){
  ...
  var defaults = {
      width: 300,                  //内容容器(layer-container)的宽度
      height: 'auto',                 //内容容器的高度
  ...
  Layer.prototype = {
    ...
    setContainerStyle: function(){
      ...
      if(_this.opts.height === 'auto'){
        _this.opts.height = _this.content.height();
      }
    ...
    show: function(element, eventType){
      ...
      $(element).on(eventType, function(e){
        ...
        if(_this.opts.onBeforeInit && (typeof _this.opts.onBeforeInit === 'function')){
          _this.opts.onBeforeInit.call(_this, $(this));
        }
        _this.create();
      });
    }
